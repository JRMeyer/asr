...
#    $ ./run-decode.sh
# 
#    This scipt should be run from a trained model directory, such as:
#
#    josh@yoga:~/git/kaldi/egs/kgz/kyrgyz-model$ ./run-decode.sh
#
...
#    within that directory (./transcriptions/wav.scp), in addition to the
#    appropriate trained model files (acoustic model, compiled graph, and 
#    word-to-symbol lookup table.
